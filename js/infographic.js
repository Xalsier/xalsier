document.addEventListener('DOMContentLoaded', () => {
    ...
    // Helper to parse date strings like "Month Day, Year - Month Day, Year" or "Present"
    ...
    // Process projects to add timeline data and version info
    ...
    function renderInfographic() {
      ...
      // Filter out projects that should be hidden from the timeline
      ...
      timelineProjects.forEach((project, index) => {
        ...
        // Add abandoned indicator if status is "Abandoned"
        if (project.description && project.description.includes('<span class="status">Abandoned</span>')) {
          const indicatorWidth = 15;
          const indicatorX = xScale(project.endDate); // Start at the end of the bar
