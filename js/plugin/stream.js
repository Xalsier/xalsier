const streams = [
    { tag: "Fortnite", views: 5, date: "March 5", thumb: "./thumb/stream/1.jpg" },
    { tag: "Fortnite", views: 4, date: "March 3", thumb: "./thumb/stream/2.jpg" },
    { tag: "Fortnite", views: 7, date: "March 2", thumb: "./thumb/stream/3.jpg" },
    { tag: "Fortnite", views: 7, date: "March 1", thumb: "./thumb/stream/4.jpg" },
    { tag: "Fortnite", views: 3, date: "February 27", thumb: "./thumb/stream/5.jpg" }
  ];
